...
bike_family_tbl <- html_home %>% 
  ...
  # (because femal bikes are also listed with the others)
...
bike_url_tbl       <- html_bike_category  %>%
  ...
  # Get the 'a' nodes, which are heirarchally underneath
...
saveRDS(bike_data_cleaned_tbl, "00_data/02_chinook/bike_data_cleaned_tbl.rds")
...
saveRDS(bike_data_colors_tbl, "00_data/02_chinook/bike_data_colors_tbl.rds")
...
saveRDS(bike_data_sizes_tbl, "00_data/02_chinook/bike_data_sizes_tbl.rds")
